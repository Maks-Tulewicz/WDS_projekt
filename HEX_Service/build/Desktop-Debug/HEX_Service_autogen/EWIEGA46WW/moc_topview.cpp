...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_TopView_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_TopView_t qt_meta_stringdata_TopView = {
    {
QT_MOC_LITERAL(0, 0, 7) // "TopView"
...
QT_INIT_METAOBJECT const QMetaObject TopView::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_TopView.data,
    qt_meta_data_TopView,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *TopView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TopView.stringdata0))
